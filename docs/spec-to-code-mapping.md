...
| **MIAF mTLS Authentication & Authorization** | WFM Server + Device Agent | • Verification: `shared-lib/mis/mtls`<br>• WFM: `symphony-margocoa/pkg/apis/v1alpha2/bindings/http/http.go::Launch()`<br>• Device Agent: `sandbox/poc/device/agent/main.go::mTLSVerifier()`<br>• [Validation Rules](https://docs.margo.org/specification/identity/svids#x509-svid-validation) |
...
| [Authentication & security](https://docs.margo.org/specification/margo-management-interface/api-requirements-and-security#authentication-mechanism) | Authentication & security | `mis/mtls/client.go`, `mis/mtls/server.go` |
