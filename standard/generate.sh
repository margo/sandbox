...
SPEC_URL="https://raw.githubusercontent.com/margo/specification/dcd619f309a5fc7947b50f8d11da398239b44165/system-design/specification/margo-management-interface/workload-management-api-1.0.0-rc.2.yaml"
curl -sSL -o "$TMP_SPEC" \
  "$SPEC_URL"
