...
################################################################################
# Margo Conformance Test Runner (CLI #2) - With RFC 9421 Signing Proxy
#
# Purpose: Execute test cases prepared by conformance.sh (CLI #1)
#          - WFM Supplier: Runs Newman with Postman collections (RFC 9421 signed)
...
#
# RFC 9421 SIGNING: Requests are signed via signing proxy (conformance-2 only)
#
################################################################################
